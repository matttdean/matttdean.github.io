...
var backgroundColors = '#2F1959';

function updateBackgroundColor() {
  if ( lvl === 1 ) {
    backgroundColors = '#2F1959';
  } else if ( lvl === 2 ) {
    backgroundColors = '#000';
  } else if ( lvl === 3 ) {
    backgroundColors = '#FEFFEF';
  }
  return colors;
};
...
function render()
{
	context.fillStyle = backgroundColors;
...
function renderScanlines()
{
	...
	for(i; i > -1; --i)
	{
		...
		context.strokeStyle = (Math.random() > 0.0001) ? '#2F1959' : '#2F1959';
		context.stroke();
	}
